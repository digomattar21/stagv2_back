...
exports.getPrivateNews = void 0;
const axios_1 = __importDefault(require("axios"));
const newsQueryMounter_1 = require("../../util/news/newsQueryMounter");
// import { ITodo } from "./../../types/todo"
// import Todo from "../../models/todo"
const getPrivateNews = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
      const yesterday =
        ((_a = req.query) === null || _a === void 0 ? void 0 : _a.from) ||
        new Date().toISOString().split("T")[0];
      const today =
        ((_b = req.query) === null || _b === void 0 ? void 0 : _b.to) ||
        new Date().toISOString().split("T")[0];
...
exports.getPrivateNews = getPrivateNews;
